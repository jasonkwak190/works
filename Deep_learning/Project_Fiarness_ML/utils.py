...
def plot_disparity_graph(demographic_parity_data,equal_opportunity_data,max_profit_data,predictive_parity_data,single_threshold_data):
    #X = np.arange(5)
    fig = plt.subplots(figsize=(12, 8))
    #fig = plt.figure()
    #ax = fig.add_axes([0, 0, 1, 1])
    width=0.1
    demoP=[get_num_predicted_positives(demographic_parity_data['African-American'])*100/len(demographic_parity_data['African-American']),get_num_predicted_positives(demographic_parity_data['Caucasian'])*100/len(demographic_parity_data['Caucasian']),get_num_predicted_positives(demographic_parity_data['Hispanic'])*100/len(demographic_parity_data['Hispanic']),get_num_predicted_positives(demographic_parity_data['Other'])*100/len(demographic_parity_data['Other'])]
    br1 = np.arange(len(demoP))
    br2 = [x + width for x in br1]
    br3 = [x + width for x in br2]
    br4 = [x + width for x in br3]
    br5 = [x + width for x in br4]
    equalP=[get_num_predicted_positives(equal_opportunity_data['African-American'])*100/len(equal_opportunity_data['African-American']),get_num_predicted_positives(equal_opportunity_data['Caucasian'])*100/len(equal_opportunity_data['Caucasian']),get_num_predicted_positives(equal_opportunity_data['Hispanic'])*100/len(equal_opportunity_data['Hispanic']),get_num_predicted_positives(equal_opportunity_data['Other'])*100/len(equal_opportunity_data['Other'])]
    maxP=[get_num_predicted_positives(max_profit_data['African-American'])*100/len(max_profit_data['African-American']),get_num_predicted_positives(max_profit_data['Caucasian'])*100/len(max_profit_data['Caucasian']),get_num_predicted_positives(max_profit_data['Hispanic'])*100/len(max_profit_data['Hispanic']),get_num_predicted_positives(max_profit_data['Other'])*100/len(max_profit_data['Other'])]
    predP=[get_num_predicted_positives(predictive_parity_data['African-American'])*100/len(predictive_parity_data['African-American']),get_num_predicted_positives(predictive_parity_data['Caucasian'])*100/len(predictive_parity_data['Caucasian']),get_num_predicted_positives(predictive_parity_data['Hispanic'])*100/len(predictive_parity_data['Hispanic']),get_num_predicted_positives(predictive_parity_data['Other'])*100/len(predictive_parity_data['Other'])]
    singleP=[get_num_predicted_positives(single_threshold_data['African-American'])*100/len(single_threshold_data['African-American']),get_num_predicted_positives(single_threshold_data['Caucasian'])*100/len(single_threshold_data['Caucasian']),get_num_predicted_positives(single_threshold_data['Hispanic'])*100/len(single_threshold_data['Hispanic']),get_num_predicted_positives(single_threshold_data['Other'])*100/len(single_threshold_data['Other'])]
    plt.bar(br1, demoP, color='b', width=width,label ='Demographic')
    plt.bar(br2, equalP, color='g', width=width,label ='Equal Opportunity')
    plt.bar(br3, maxP, color='r', width=width,label ='Max Profit')
    plt.bar(br4, predP, color='c', width=width,label ='Predictive')
    plt.bar(br5, singleP, color='m', width=width,label ='Single Threshold')
    plt.xticks([r + width for r in range(len(demoP))],
